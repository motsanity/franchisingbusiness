                ...
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        ...
                        <p class="mbr-text mbr-fonts-style mt-3 display-7">
                            Manage and operate at home up to <b>25</b> riders. Every successful deliveries from your riders, you will get 7% commission. No quotas. No maintenance. Your choice.</p>
                    </div>
                ...
                <div class="plan">
                    <div class="plan-header">
                        ...
                        <div class="plan-price">
                            <p class="price mbr-fonts-style m-0 display-1">₱<strong>53,664</strong></p>
                    ...
                    <div class="plan-body">
                        <div class="plan-list mb-4">
                            <ul class="list-group mbr-fonts-style list-group-flush display-7">
                                <li class="list-group-item">Hire up to 100 Riders</li><li class="list-group-item">Toktok Delivery</li><li class="list-group-item">Toktok Food</li><li class="list-group-item">Toktok Mall</li>
                            </ul>
                        </div>
            ...
            <div class="col-12 col-md-6 align-center col-lg-6">
                <div class="plan">
                    ...
                    <div class="plan-body">
                        <div class="plan-list mb-4">
                            <ul class="list-group mbr-fonts-style list-group-flush display-7">
                                <li class="list-group-item">Hire up to 25 riders</li><li class="list-group-item">Toktok Delivery</li><li class="list-group-item">Toktok Food</li><li class="list-group-item">Toktok Mall</li>
                            </ul>
                        </div>
