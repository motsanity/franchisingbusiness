    ...
    <div class="container-fluid mt-4 mb-5">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="">
                <form action="viewer-sk-form.php" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
                    <div class="row">
                        <?php
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-12 col-sm-12 form-group mb-3" data-for="phone">
                            ...
                            <input type="text" name="inq" value="sk" vdata-form-field="name" class="form-control" hidden>
                        </div>
